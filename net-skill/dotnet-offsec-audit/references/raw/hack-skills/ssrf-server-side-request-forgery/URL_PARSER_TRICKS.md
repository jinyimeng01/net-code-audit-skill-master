<!--
Source: G:\tmp\安全项目研究\.netskill\hack-skills\skills\ssrf-server-side-request-forgery\URL_PARSER_TRICKS.md
Archived as: raw hack-skill reference for authorized .NET audit synthesis.
Purpose: provenance-only material; load only when structured references are insufficient.
-->
