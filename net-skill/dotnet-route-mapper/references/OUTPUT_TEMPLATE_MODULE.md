...
>    - WCF 服务: `{project_name}_ws_{service_name}_{YYYYMMDD_HHMMSS}.md`
>
...
**上下文路径**: 【填写：如 /admin】
**框架**: 【填写：如 ASP.NET Core + Web API + WCF】
...
### 【填写：框架类型，如 ASP.NET Core 路由 / Web API 路由 / MVC 路由 / WebForms 路由 / WCF 方法】 (namespace: 【填写：namespace】)

<!-- 以下区块按实际接口数量重复 -->

=== [【填写：序号】] 【填写：接口标识，如 GET /api/users / User_List.aspx】 ===
...
|--------|------|
| 总接口数 | 【填写】 |
| ASP.NET Core 路由 | 【填写；若无填 0】 |
| Web API 路由 | 【填写；若无填 0】 |
| MVC 路由 | 【填写；若无填 0】 |
| WebForms 路由 | 【填写；若无填 0】 |
| WCF 方法 | 【填写；若无填 0】 |
...
- [ ] WCF 接口的 URL 来自配置文件的 address 属性（非推断）
